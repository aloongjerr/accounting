# A comprehensive filament accounting package.
...
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/aloongjerr/accounting/fix-php-code-style-issues.yml?branch=main&label=code%20style&style=flat-square)](https://github.com/aloongjerr/accounting/actions?query=workflow%3A"Fix+PHP+code+styling"+branch%3Amain)
...
```php
$accounting = new AloongJerr\Accounting();
echo $accounting->echoPhrase('Hello, AloongJerr!');
```
